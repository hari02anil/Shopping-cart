...
<body>
    ...
    <form  method ='post'>
    <label id="fnamename">First name</label>    <input type="text" id="fname" ><br><br>
    
    <label id="dobname">Date of birth</label>    <input type="date" id="dob" ><br><br> 

    <label id="gendername">Gender</label> <select id="gender" >
    ...
    <label id="emailname">Email id</label>    <input type="email" id="email" ><br><br>

    <label id="phonename">Phone number</label>    <input type="number" id="phno" ><br><br>

    
    <label id="usernamename" >Username</label>    <input type="text" id="uname" ><br><br>

    <label id="passwordname" >Password</label>    <input type="password" id="password" ><br><br>

    <label id="cpasswordname" >Confirm password</label>    <input type="password" id="cpassword" ><br><br>

    <label><input type="checkbox" id="terms"> I agree to the terms and conditions</label><br><br>
