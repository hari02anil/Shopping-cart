<?php
session_start();
include 'db.php'; // Ensure this file contains the correct PDO connection setup
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        ");
        $total_amount = $product['price']; // Assuming the user buys one unit
        ...
        $stmt->execute([
            ...
            'quantity'   => 1, // Assuming user buys only 1 unit
            'price'      => $product['price']
        ]);
