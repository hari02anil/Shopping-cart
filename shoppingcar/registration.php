...
<body>
<img src="images\shop img.jpg" width="100%">
<div class="form-container"><br><br><br><br><br><br><br><br>
    ...
    <br>
        ...
        <input type="checkbox" name="agree" required><center><a href ="policy.html"> I agree to the policy</a><br>
        <input type="submit" value="Register">
        <input type="reset" id="canceButton" value="Cancel">
    </form>
</div>
